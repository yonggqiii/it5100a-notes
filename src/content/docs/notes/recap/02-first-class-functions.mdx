...
```python frame="terminal" title="Python interactive session (add)" showLineNumbers=false
>>> add(1)(2)
3
```
...
```
```python frame="terminal" title="Python interactive session (filter)" showLineNumbers=false
...
```python frame="terminal" title="Python interactive session (reduce)" showLineNumbers=false
...
```python frame="terminal" title="Python interactive session (map vs flatmap)" showLineNumbers=false
...
```python frame="terminal" title="Python interactive session (flatmap)" showLineNumbers=false
