...
```haskell frame="terminal" title="GHCi session (eqLast example run)" showLineNumbers=false
...
```haskell frame="terminal" title="GHCi session (isPalindrome example run)" showLineNumbers=false
ghci> isPalindrome "a"
True
...
```haskell frame="terminal" title="GHCi session (taxiFare example run)" showLineNumbers=false
...
```haskell frame="terminal" title="GHCi session (burgerPrice example run)" showLineNumbers=false
...
```haskell frame="terminal" title="GHCi session (sumDigits example run)" showLineNumbers=false
ghci> sumDigits 123
6
...
```haskell frame="terminal" title="GHCi session (@: example run)" showLineNumbers=false
ghci> [1, 2, 3] @: (1, 4)
[2,3]
ghci> [1, 2, 3] @: (4, 1)
[]
