...
Recall [Chapter 2.3 (Types#Algebraic Data Types)](/it5100a-notes/notes/types/03-adt) where we defined an `Expr` GADT.
...
```python title="Python interactive session" frame="terminal" showLineNumbers=false
>>> len([1, 2, 3])
3
>>> 'abcd'[3]
'c'
