...
> Note: `Validation` is not included in Haskell's Prelude. You can use the `Validation` datatype definition and its supporting typeclass instances as defined in the hands-on portion of [Chapter 4.4 (Railway Pattern#Validation)](/it5100a-notes/notes/railway/04-validation/).
