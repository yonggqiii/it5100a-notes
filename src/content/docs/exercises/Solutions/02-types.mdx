...
```haskell title="BurgerPrice.hs" startLineNumber={9}
...
```haskell title="BurgerPrice.hs" startLineNumber={10}
...
``` haskell title="DropConsecutiveDuplicates.hs"
...
``` haskell title="Zipper.hs" startLineNumber={4}
...
``` haskell title="BST.hs" startLineNumber={2}
...
``` haskell title="BST.hs" startLineNumber={8}
...
``` haskell title="BST.hs" startLineNumber={11}
...
``` haskell title="BST.hs" startLineNumber={13}
...
``` haskell title="Shape.hs" ins={3,8}
...
```python title="Shape.py" ins={5-7,14-15,32,33,23,24}
class Shape(ABC):
    @abstractmethod
    def area(self) -> float:
        pass
...
```python title="BankAccounts.py" startLineNumber={2}
from dataclasses import dataclass
...
```python title="BankAccounts.py" startLineNumber={15}
...
```python title="BankAccounts.py" startLineNumber={21}
...
```python title="BankAccounts.py" startLineNumber={28}
...
```python title="BankAccounts.py" startLineNumber={46}
...
```python title="BankAccounts.py" startLineNumber={57}
...
```python title="BankAccounts.py" startLineNumber={74}
...
```python title="BankAccounts.py" startLineNumber={80}
...
```python title="BankAccounts.py" startLineNumber={89}
...
```python title="BankAccounts.py" startLineNumber={101}
...
```haskell title="GHCi session" showLineNumbers=false frame="terminal"
...
```haskell title="AVL.hs" startLineNumber={13}
in' _ Empty = False
in' x (Node left a right)
  | x == a    = True
  | x < a     = in' x left
...
```haskell title="AVL.hs" startLineNumber={44}
...
```haskell title="AVL.hs" startLineNumber={62}
-- Pretty printing
